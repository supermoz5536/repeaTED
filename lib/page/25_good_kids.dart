...
class GoodKidsPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const GoodKidsPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<GoodKidsPage> createState() => _GoodKidsPageState();
}

class _GoodKidsPageState extends ConsumerState<GoodKidsPage> {
  ...
  void initState() {
    ...
    currentPageIndex = widget.transitionConstructor!.currentPageIndex;
      ...
      futureList = Video.loadGoodKids().then((result) {
        if (result != null) {
          setState(() {
            wholeItems = result;
