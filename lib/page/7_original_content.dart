...
class OriginalContentPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const OriginalContentPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<OriginalContentPage> createState() => _OriginalContentPageState();
}

class _OriginalContentPageState extends ConsumerState<OriginalContentPage> {
