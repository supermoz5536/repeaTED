...
class TabiEatsPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const TabiEatsPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<TabiEatsPage> createState() => _TabiEatsState();
}

class _TabiEatsState extends ConsumerState<TabiEatsPage> {
  ...
  void initState() {
    ...
    currentPageIndex = widget.transitionConstructor!.currentPageIndex;
      ...
      futureList = Video.loadTabiEats().then((result) {
        if (result != null) {
          setState(() {
            wholeItems = result;
                ...
                : Center(
                  child: Wrap(
                      ...
                      children: List<Widget>.generate(pagedList![currentPageIndex!]!.length, (index) {
                          ...
                          String? extractedSpeakerName = Utility.extractChannelName(currentVideo);
