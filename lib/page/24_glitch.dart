...
class GlitchPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const GlitchPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<GlitchPage> createState() => _GlitchPageState();
}

class _GlitchPageState extends ConsumerState<GlitchPage> {
  ...
  void initState() {
    ...
    currentPageIndex = widget.transitionConstructor!.currentPageIndex;
      ...
      futureList = Video.loadGlitch().then((result) {
        if (result != null) {
          setState(() {
            wholeItems = result;
