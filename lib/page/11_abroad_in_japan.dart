...
class AbroadInJapanPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const AbroadInJapanPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<AbroadInJapanPage> createState() => _AbroadInJapanPageState();
}

class _AbroadInJapanPageState extends ConsumerState<AbroadInJapanPage> {
