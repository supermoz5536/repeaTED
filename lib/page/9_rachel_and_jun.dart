...
class RachelAndJunPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const RachelAndJunPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<RachelAndJunPage> createState() => _RachelAndJunPageState();
}

class _RachelAndJunPageState extends ConsumerState<RachelAndJunPage> {
  ...
  void initState() {
    ...
    currentPageIndex = widget.transitionConstructor!.currentPageIndex;
      ...
      futureList = Video.loadRachelAndJun().then((result) {
        if (result != null) {
          setState(() {
            wholeItems = result;
