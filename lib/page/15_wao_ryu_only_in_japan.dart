...
class WaoRyuOnlyInJapanPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const WaoRyuOnlyInJapanPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<WaoRyuOnlyInJapanPage> createState() => _WaoRyuOnlyInJapanPageState();
}

class _WaoRyuOnlyInJapanPageState extends ConsumerState<WaoRyuOnlyInJapanPage> {
  ...
  void initState() {
    ...
    currentPageIndex = widget.transitionConstructor!.currentPageIndex;
      ...
      futureList = Video.loadWaoRyuOnlyInJapan().then((result) {
        if (result != null) {
          setState(() {
            wholeItems = result;
