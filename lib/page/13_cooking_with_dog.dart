...
class CookingWithDogPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const CookingWithDogPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<CookingWithDogPage> createState() => _CookingWithDogPageState();
}

class _CookingWithDogPageState extends ConsumerState<CookingWithDogPage> {
  ...
  void initState() {
    ...
    currentPageIndex = widget.transitionConstructor!.currentPageIndex;
      ...
      futureList = Video.loadCookingWithDog().then((result) {
        if (result != null) {
          setState(() {
            wholeItems = result;
