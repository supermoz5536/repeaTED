...
class QualityOfEnglishLifePage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const QualityOfEnglishLifePage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<QualityOfEnglishLifePage> createState() => _QualityOfEnglishLifePageState();
}

class _QualityOfEnglishLifePageState extends ConsumerState<QualityOfEnglishLifePage> {
  ...
  void initState() {
    ...
    currentPageIndex = widget.transitionConstructor!.currentPageIndex;
      ...
      futureList = Video.loadQualityOfEnglishLife().then((result) {
        if (result != null) {
          setState(() {
            wholeItems = result;
