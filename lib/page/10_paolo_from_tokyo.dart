...
class PaoloFromTokyoPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const PaoloFromTokyoPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<PaoloFromTokyoPage> createState() => _PaoloFromTokyoPageState();
}

class _PaoloFromTokyoPageState extends ConsumerState<PaoloFromTokyoPage> {
