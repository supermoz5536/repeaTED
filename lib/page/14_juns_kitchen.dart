...
class JunsKitchenPage extends ConsumerStatefulWidget {
  final PageTransitionConstructor? transitionConstructor;
  const JunsKitchenPage(this.transitionConstructor, {super.key});

  @override
  ConsumerState<JunsKitchenPage> createState() => _JunsKitchenPageState();
}

class _JunsKitchenPageState extends ConsumerState<JunsKitchenPage> {
  ...
  void initState() {
    ...
    currentPageIndex = widget.transitionConstructor!.currentPageIndex;
      ...
      futureList = Video.loadJunsKitchen().then((result) {
        if (result != null) {
          setState(() {
            wholeItems = result;
